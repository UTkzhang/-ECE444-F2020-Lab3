...
```git clone https://github.com/UTkzhang/ECE444-F2020-Lab3 & cd ECE444-F2020-Lab3```
Check out the appropriate experimentation branch
```git checkout lab4_Microservice_Experiment```
To start the docker container, simply use docker-compose
```docker-compose up```
